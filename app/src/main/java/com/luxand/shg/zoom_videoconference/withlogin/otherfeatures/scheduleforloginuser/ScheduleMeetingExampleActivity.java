package com.luxand.shg.zoom_videoconference.withlogin.otherfeatures.scheduleforloginuser;
...
public class ScheduleMeetingExampleActivity extends Activity implements PreMeetingServiceListener, OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences=new MySharedPreference(ScheduleMeetingExampleActivity.this);
        ...
        mTxtDate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ScheduleMeetingExampleActivity.this,
        ...
        mTxtTimeFrom.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final Calendar c = Calendar.getInstance();
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(ScheduleMeetingExampleActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                mTxtTimeFrom.setText(hourOfDay + ":" + minute);
                            }
                        }, mHour, mMinute, false);
        ...
        mTxtTimeTo.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final Calendar c = Calendar.getInstance();
                mHour = c.get(Calendar.HOUR_OF_DAY);
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(ScheduleMeetingExampleActivity.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                mTxtTimeTo.setText(hourOfDay + ":" + minute);
                            }
                        }, mHour, mMinute, false);
                timePickerDialog.show();
            }
    ...
    private void onClickSchedule() {
        ...
        if (topic.length() == 0) {
            ...
            return;
        }/*if (timeCheck(mTxtTimeFrom.getText().toString(),mTxtTimeTo.getText().toString())) {
            Toast.makeText(this, "from date less than todate", Toast.LENGTH_LONG).show();
            return;
        }*/

        if (mPreMeetingService == null) return;

        ProgressBarDialog.showLoadingDialog(ScheduleMeetingExampleActivity.this);
    ...
    public void onScheduleMeeting(int result, long meetingNumber) {
        ...
        if (result == PreMeetingError.PreMeetingError_Success) {
            ...
            object.addProperty("role_id",""+preferences.getPref(PrefKeys.COORIDINATOR_ID));
            object.addProperty("user_id",""+preferences.getPref(PrefKeys.USER_TYPE));
            object.addProperty("topic",""+mEdtTopic.getText().toString());
            object.addProperty("date",""+mTxtDate.getText().toString());
            object.addProperty("fromtime",""+mTxtTimeFrom.getText().toString());
            object.addProperty("totime",""+mTxtTimeTo.getText().toString());
            object.addProperty("meetingNumber",""+ String.valueOf(meetingNumber));

            Log.d("meetinginfo",""+object.toString());
   ...
   /* public void createmeeting(JsonObject object){

        Helper.getInstance(ScheduleMeetingExampleActivity.this).RestApi()
                .createMeeting(object)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnSubscribe(__ -> ProgressBar.showLoadingDialog(ScheduleMeetingExampleActivity.this))
                ...
                .subscribe(new Observer<Success>() {
                    ...
                    @Override
                    public void onNext(Success key) {
                        if(key.getMsg().equalsIgnoreCase("success")) {
                            finish();
                        }
                    }
