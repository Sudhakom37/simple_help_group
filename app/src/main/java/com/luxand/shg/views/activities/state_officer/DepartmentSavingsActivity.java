...
public class DepartmentSavingsActivity extends BaseActivity {
    private static final String TAG = "DepartmentSavingsFragment";
    ...
    TextView tv_savings_value,tv_barchart_name,tv_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_savings_department);
        ...
        ivMenuBack.setOnClickListener(view -> {
            if(data.getLabel() != null &&data.getLabel().equalsIgnoreCase("group")){
                ...
                getDashboard(DepartmentSavingsActivity.this,districtId,mandalId,"");
                ...
                getDashboard(DepartmentSavingsActivity.this,districtId,"","");
                ...
                getDashboard(DepartmentSavingsActivity.this,"","","");
        ...
        barchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                if(data.getLabel() != null &&data.getLabel().equalsIgnoreCase("district")){
                    tv_barchart_name.setText("District Wise Savings");
                    districtId =String.valueOf(dataList.get((int)e.getX()).getId());
                    getDashboard(DepartmentSavingsActivity.this,districtId,"","");
                }else if(data.getLabel() != null && data.getLabel().equalsIgnoreCase("mandal")){
                    tv_barchart_name.setText("Mandal Wise Savings");
                    mandalId = String.valueOf(dataList.get((int)e.getX()).getId());
                    getDashboard(DepartmentSavingsActivity.this,districtId,mandalId,"");
                }else if(data.getLabel() != null && data.getLabel().equalsIgnoreCase("village")){
                    tv_barchart_name.setText("Village Wise Savings");
                    villageId = String.valueOf(dataList.get((int)e.getX()).getId());
                    getDashboard(DepartmentSavingsActivity.this,districtId,mandalId,villageId);
                }
    ...
    private void getDashboard(Context mContext, String district_id, String mandal_id, String village_id) {
        ...
        RetrofitInstance.getInstance(mContext).getRestAdapter()
                .getDepartmentSavings(district_id,mandal_id,village_id)
                ...
                .subscribe(new Subscriber<BarChartModel>() {
                    ...
                    public void onNext(BarChartModel barChartModel) {
                        ...
                        if (barChartModel.getSuccess()) {
                            ...
                            tv_savings_value.setText(String.valueOf(data.getTotal()));
                            try {
                                labels.clear();
                                labels1.clear();
                                entries.clear();
