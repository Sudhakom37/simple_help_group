package com.luxand.shg.views.enrollment;
...
import com.luxand.shg.views.fragments.home.EnrollmentListFragment;
import com.luxand.shg.helper.Helper;
import com.luxand.shg.helper.MySharedPreference;
import com.luxand.shg.helper.PrefKeys;
import com.luxand.shg.views.identicalmap.Face_Register_Identical;
...
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.DATFILE;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.IMAGES;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.already_face_exit;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.backCameraFound;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.canvasHeight;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.confidenceEyesOpenPercent;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.counttime;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.database;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.detected;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.filePath;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.flag;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.flag_outofbox;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.flag_toast;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.frontCameraFound;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.imgg;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.mCountDownTimer;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.mySharedPreference;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.named1;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.ok;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.progressbar;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.registeredUsersList;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.single_dat;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.squarelength;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.st_id;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.st_name;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.submit;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.tap;
import static com.luxand.shg.views.enrollment.Student_Face_Enroll.timer_updatecompl;

public class Student_Face_Enroll extends BaseActivity implements View.OnClickListener {

    private boolean mIsFailed = false;
    private Preview1 mPreview;
    public static ProcessImageAndDrawResults1 mDraw;
    public static float sDensity = 1.0f;
    public static String FROM,database = "",single_dat = "",st_name="",st_id,path="",compresspath="",DATFILE="",IMAGES="",filePath_twin_img,st_image_status,st_MatchStatus,filePath,APPLICATION_ID = "com.luxand.iams_schools_v4_single";
...
class ProcessImageAndDrawResults1 extends View {
    ...
    public ProcessImageAndDrawResults1(Context context) {
        ...
        mPaintGreen.setTextSize(25 * Student_Face_Enroll.sDensity);
        ...
        mPaintBlue.setTextSize(25 * Student_Face_Enroll.sDensity);
        ...
        mPaintBlueTransparent.setTextSize(25 * Student_Face_Enroll.sDensity);
        ...
        mPaintGreenTransparent.setTextSize(25 * Student_Face_Enroll.sDensity);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        faceLock.unlock();
        int shift = (int)(22 * Student_Face_Enroll.sDensity);
        ...
        for (int i=0; i<face_count[0]; ++i) {
            ...
            if (!named) {
                ...
                if (!detected) {
                    ...
                    try {
                        registeredUsersList = new EnrollmentListFragment().memberList;

                        for (int j = 0; j < registeredUsersList.size(); j++) {
                            if (st_name.equalsIgnoreCase("" + registeredUsersList.get(j).getUuid())) {
                                name_t = registeredUsersList.get(j).getName();
                                break;
                            }
                        }
                    } catch (Exception e) {
                    ...
                    d.setContentView(R.layout.face_detect_register_exits_dilog);
                    ...
                    submit = (TextView) d.findViewById(R.id.submit);
                    TextView name = (TextView) d.findViewById(R.id.name);
                    TextView cancel = (TextView) d.findViewById(R.id.cancel);
                    imgg =  d.findViewById(R.id.imgg);
                    String msg = getResources().getString(R.string.exitsfacemsg);
                    text.setText(msg);
                    id.setText("Enrollment Id : " + st_name);
                    name.setText("Name : " + name_t);
                    try {
                        d.setCanceledOnTouchOutside(false);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    imgg.setVisibility(GONE);
                    ...
                    ok.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            progressbar.setProgress(counttime);
                            detected = true;
                            Preview1.mFinished = true;
                            if (Preview1.mCamera != null) {
                                Preview1.mCamera.setPreviewCallback(null);
                                Preview1.mCamera.stopPreview();
                                Preview1.mCamera.release();
                                Preview1.mCamera = null;
                            }

                            Intent intent=new Intent(mContext, Face_Register_Identical.class);
                            intent.putExtra("type","");
                            mySharedPreference.setPref(PrefKeys.MAPPING_ID,st_name);
                            ...
                            if(tap==0){
                                ...
                                ok.setOnClickListener(new OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        String path =""+myDir_file + "/" + single_dat;
                                        //FSDK.SaveTrackerMemoryToFile(mTracker, path);
                                        FSDK.SaveTrackerMemoryToFile(mTracker, filePath);
                                        ...
                                        SQLite.update(Student_EnroolList_Local.class)
                                                .set(Student_EnroolList_Local_Table.isEnrolled.eq("1"),
                                                        ...
                                                        Student_EnroolList_Local_Table.sectiondatfile.eq(filePath),
                                         ...
                                         /*int it=FSDK.PurgeID(mTracker, Long.parseLong(userName));
                                         Log.d("PurgeID",""+it);*/
                                        /*Intent intent=new Intent(mContext, Face_Register_Identical.class);
                                        intent.putExtra("type","normal");*/
                                        mySharedPreference.setPref(PrefKeys.MAPPING_ID,"");
                                        //mContext.startActivity(intent);
                                        ((AppCompatActivity)mContext).finish();
                                    }
                                });
