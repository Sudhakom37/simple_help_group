...
public class DepartmentInActiveGroupsActivity extends BaseActivity {
    ...
    TextView tv_in_active_groups_value,tv_barchart_name,tv_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_in_active_groups_department);
        ...
        tv_in_active_groups_value = findViewById(R.id.tv_active_groups_value);
        tv_barchart_name = findViewById(R.id.tv_barchart_name);
        preference = new MySharedPreference(this);
        tv_title = findViewById(R.id.tv_title);
        tv_title.setText("In Active Groups");
        ...
        ivMenuBack.setOnClickListener(view -> {
            if(data.getLabel() != null &&data.getLabel().equalsIgnoreCase("group")){
                ...
                getDashboard(DepartmentInActiveGroupsActivity.this,districtId,mandalId,"");
                ...
                getDashboard(DepartmentInActiveGroupsActivity.this,districtId,"","");
                ...
                getDashboard(DepartmentInActiveGroupsActivity.this,"","","");
                //getDashboard(DepartmentActiveGroupsActivity.this,districtId,mandalId,villageId);
            }else{
                finish();
            }
        });
        //((DepartmentInActiveGroupsActivity)this).tv_title.setText("In Active Groups");
        getDashboard(this,"","","");
        ...
        barchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                if(data.getLabel() != null && data.getLabel().equalsIgnoreCase("district")){
                    ...
                    tv_barchart_name.setText("Village Wise Groups");
                    villageId = String.valueOf(dataList.get((int)e.getX()).getId());
                    getDashboard(DepartmentInActiveGroupsActivity.this,String.valueOf(dataList.get((int)e.getX()).getId()),mandalId,villageId);
                }
                ...
                .subscribe(new Subscriber<BarChartModel>() {
                    ...
                    public void onNext(BarChartModel barChartModel) {
                        ...
                        if (barChartModel.getSuccess()) {
                            ...
                            label = data.getLabel();
                            tv_in_active_groups_value.setText(String.valueOf(data.getTotal()));
                            try {
                                labels.clear();
                                labels1.clear();
                                entries.clear();
