...
import com.luxand.shg.views.activities.Face_SignIn;
import com.luxand.shg.views.activities.LoginActivity;
...
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.backCameraFound;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.confidenceEyesOpenPercent;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.facenotrecognized;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.faceservicecheck;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.flag;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.named1;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.oldeyes;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.percent;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.progressbar;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.mySharedPreference;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.st_id;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.st_name;
import static com.luxand.shg.views.activities.division_offcer.MeetingIdentificationActivity.action;


public class MeetingIdentificationActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (res != FSDK.FSDKE_OK) {
            mIsFailed = true;
            showErrorAndClose("FaceSDK activation failed, open App Again", res);
        } else {
            FSDK.Initialize();
    ...
    private void openCamera() {
        ...
        View buttons = inflater.inflate(R.layout.activity_division_identification, null );
        ...
        ivMenuBack = buttons.findViewById(R.id.iv_menu_back);
        ivMenuOpen = buttons.findViewById(R.id.iv_menu_open);
    ...
    public void onClick(@NonNull View view) {
        ...
        if (view.getId() == R.id.submit) {
           ...
           // startActivityBase(MeetingIdentificationActivity.this, DivisionStartMeetingMapActivity.class);
...
class ProcessImageAndDrawResults extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(named1){
            ...
            object.addProperty("user_id",mySharedPreference.getPref(PrefKeys.USER_ID));
    ...
    public void login(JsonObject object){
        ...
        RetrofitInstance.getInstance(mContext).
                getRestAdapter()
                .authenticateDivisionOfficer(object)
                ...
                .subscribe(new Subscriber<SuccessModel>() {
                    ...
                    public void onNext(SuccessModel login) {
                        ...
                        Intent intent = new Intent(mContext, DivisionStartMeetingMapActivity.class);
                        intent.putExtra("Action",action);
                        mContext.startActivity(intent);
                        /*((BaseActivity)mContext).startActivityBase(mContext, DivisionStartMeetingMapActivity.class);
