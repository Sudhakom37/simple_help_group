...
import static com.luxand.shg.views.activities.FaceLoginActivity.DATFILE;
import static com.luxand.shg.views.activities.FaceLoginActivity.IMAGES;
import static com.luxand.shg.views.activities.FaceLoginActivity.already_face_exit;
import static com.luxand.shg.views.activities.FaceLoginActivity.backCameraFound;
import static com.luxand.shg.views.activities.FaceLoginActivity.canvasHeight;
import static com.luxand.shg.views.activities.FaceLoginActivity.confidenceEyesOpenPercent;
import static com.luxand.shg.views.activities.FaceLoginActivity.counttime;
import static com.luxand.shg.views.activities.FaceLoginActivity.database;
import static com.luxand.shg.views.activities.FaceLoginActivity.detected;
import static com.luxand.shg.views.activities.FaceLoginActivity.filePath;
import static com.luxand.shg.views.activities.FaceLoginActivity.mCountDownTimer;
import static com.luxand.shg.views.activities.FaceLoginActivity.mDraw;
import static com.luxand.shg.views.activities.FaceLoginActivity.mac_address;
import static com.luxand.shg.views.activities.FaceLoginActivity.mySharedPreference;
import static com.luxand.shg.views.activities.FaceLoginActivity.named1;
import static com.luxand.shg.views.activities.FaceLoginActivity.progressbar;
import static com.luxand.shg.views.activities.FaceLoginActivity.sDensity;
import static com.luxand.shg.views.activities.FaceLoginActivity.squarelength;
import static com.luxand.shg.views.activities.FaceLoginActivity.st_id;
import static com.luxand.shg.views.activities.FaceLoginActivity.st_name;
import static com.luxand.shg.views.activities.FaceLoginActivity.tap;
import static com.luxand.shg.views.activities.FaceLoginActivity.taptoenroll;
import static com.luxand.shg.views.activities.FaceLoginActivity.timer_updatecompl;
...
public class FaceLoginActivity extends BaseActivity implements View.OnClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            DATFILE = Helper.DATFILE+"/Login";
            IMAGES = Helper.IMAGES+"/Login";
            detected = false;
    ...
    class ProcessImageAndDrawResults1 extends View {
        ...
        public ProcessImageAndDrawResults1(Context context) {
            ...
            mPaintBlueTransparent.setTextSize(25 * sDensity);
            ...
            mPaintGreenTransparent.setTextSize(25 * sDensity);
            ...
            RetrofitInstance.getInstance(mContext).
                    ...
                    .subscribe(new Subscriber<Registration>() {
                        ...
                        public void onError(Throwable e) {
                            Log.e(TAG, "onError: login"+e.getMessage() );
                        ...
                        public void onNext(Registration registration) {
                            ...
                            Log.d(TAG, "onNext: login"+registration.getData().getStatus());
