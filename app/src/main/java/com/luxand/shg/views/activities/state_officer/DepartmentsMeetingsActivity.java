...
public class DepartmentsMeetingsActivity extends BaseActivity {

    private static final String TAG = "DepartmentsMeetingsActivity";
    ...
    private List<BarChartModel.Results> analytics_lists=new ArrayList<>();
    private TextView tv_meetings_value,tv_barchart_name,tv_title;
    ImageView ivMenuOpen,ivMenuBack;
    private List<BarChartModel.Results> dataList;
    private BarChartModel.Data data;
    private String districtId,mandalId,villageId;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_meetings_department);
        barchart = findViewById(R.id.barchart);
        ivMenuOpen = findViewById(R.id.iv_menu_open);
        ivMenuBack = findViewById(R.id.iv_menu_back);
        tv_meetings_value = findViewById(R.id.tv_active_groups_value);
        tv_barchart_name = findViewById(R.id.tv_active_groups_name);
        preference = new MySharedPreference(this);
        tv_title = findViewById(R.id.tv_title);
        tv_title.setText("Meetings");
        ...
        ivMenuBack.setOnClickListener(view -> {
            if(data.getLabel() != null &&data.getLabel().equalsIgnoreCase("group")){
                ...
                getDashboard(DepartmentsMeetingsActivity.this,districtId,mandalId,"");
                ...
                getDashboard(DepartmentsMeetingsActivity.this,districtId,"","");
                ...
                getDashboard(DepartmentsMeetingsActivity.this,"","","");
                //getDashboard(DepartmentActiveGroupsActivity.this,districtId,mandalId,villageId);
            }else{
                finish();
            }
        });
        //((StateOfficerMainActivity)this).tv_title.setText("Active Groups");
        getDashboard(this,"","","");
        ...
        barchart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                if(data.getLabel() != null &&data.getLabel().equalsIgnoreCase("district")){
                    ...
                    tv_barchart_name.setText("Village Wise Groups");
                    villageId = String.valueOf(dataList.get((int)e.getX()).getId());
                    getDashboard(DepartmentsMeetingsActivity.this,districtId,mandalId,villageId);
                }
    ...
    private void getDashboard(Context mContext, String district_id, String mandal_id, String village_id) {
        ...
        RetrofitInstance.getInstance(mContext).getRestAdapter()
                .getDepartmentMeetings(district_id,mandal_id,village_id)
                ...
                .subscribe(new Subscriber<BarChartModel>() {
                    ...
                    public void onNext(BarChartModel barChartModel) {
                        ...
                        if (barChartModel.getSuccess()) {
                            ...
                            tv_meetings_value.setText(String.valueOf(data.getTotal()));
                            try {
                                labels.clear();
                                labels1.clear();
                                entries.clear();
